module top (clk,
 ...
 sky130_fd_sc_hd__o31a_1 _058_ (.A1(_022_),
    ...
    .B1(net12),
    .X(_026_));
 sky130_fd_sc_hd__o21a_1 _059_ (.A1(\controller_inst.clear ),
    .A2(_026_),
    .B1(_020_),
    .X(_003_));
 ...
 sky130_fd_sc_hd__a21boi_1 _061_ (.A1(\data_edge_detector_inst.reset_counter[1] ),
    ...
    .B1_N(net13),
    .Y(_027_));
 sky130_fd_sc_hd__o21a_1 _062_ (.A1(\data_counter_inst.inc ),
    .A2(_027_),
    .B1(_020_),
    .X(_005_));
 sky130_fd_sc_hd__o21a_1 _063_ (.A1(\data_edge_detector_inst.input_buffer[1] ),
    ...
    .X(_028_));
 sky130_fd_sc_hd__a311o_1 _064_ (.A1(\data_edge_detector_inst.reset_counter[1] ),
    .A2(\data_edge_detector_inst.reset_counter[0] ),
    .A3(net13),
    .B1(net2),
    .C1(_028_),
 ...
 sky130_fd_sc_hd__and3_1 _065_ (.A(_020_),
    ...
    .C(net11),
    .X(_000_));
 sky130_fd_sc_hd__and4b_1 _066_ (.A_N(\data_edge_detector_inst.input_buffer[1] ),
