module top (clk,
 ...
 sky130_fd_sc_hd__inv_2 _053_ (.A(start),
    ...
    .VPWR(VPWR),
    .Y(_021_));
 sky130_fd_sc_hd__and3_2 _054_ (.A(_020_),
    .B(start),
    .C(ready),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_000_));
 sky130_fd_sc_hd__and2_2 _055_ (.A(\data_edge_detector_inst.state[0] ),
    .B(_020_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_022_));
 sky130_fd_sc_hd__and3b_2 _056_ (.A_N(\data_edge_detector_inst.input_buffer[1] ),
    ...
    .VPWR(VPWR),
    .X(_001_));
 sky130_fd_sc_hd__or3_2 _057_ (.A(count_out[4]),
    .B(count_out[3]),
    .C(count_out[2]),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_023_));
 sky130_fd_sc_hd__nand2_2 _058_ (.A(count_out[6]),
    .B(count_out[5]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_024_));
 sky130_fd_sc_hd__nand2_2 _059_ (.A(count_out[1]),
    .B(count_out[0]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_025_));
 sky130_fd_sc_hd__nor3_2 _060_ (.A(_023_),
    .B(_024_),
    .C(_025_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_026_));
 sky130_fd_sc_hd__a221o_2 _061_ (.A1(_021_),
    .A2(ready),
    .B1(running),
    .B2(_026_),
    .C1(rst),
    ...
    .VPWR(VPWR),
    .X(_002_));
 sky130_fd_sc_hd__o31a_2 _062_ (.A1(_023_),
    .A2(_024_),
    .A3(_025_),
    .B1(running),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_027_));
 sky130_fd_sc_hd__o21a_2 _063_ (.A1(\controller_inst.clear ),
    .A2(_027_),
    .B1(_020_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_003_));
 sky130_fd_sc_hd__a21boi_2 _064_ (.A1(\data_edge_detector_inst.reset_counter[1] ),
    ...
    .VPWR(VPWR),
    .Y(_028_));
 sky130_fd_sc_hd__o21a_2 _065_ (.A1(\data_counter_inst.inc ),
    .A2(_028_),
    .B1(_020_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_005_));
 sky130_fd_sc_hd__o21a_2 _066_ (.A1(\data_edge_detector_inst.input_buffer[1] ),
    .A2(_019_),
    ...
    .VPWR(VPWR),
    .X(_029_));
 sky130_fd_sc_hd__a311o_2 _067_ (.A1(\data_edge_detector_inst.reset_counter[1] ),
    .A2(\data_edge_detector_inst.reset_counter[0] ),
    .A3(temp_reset),
    .B1(rst),
    .C1(_029_),
    ...
    .VPWR(VPWR),
    .X(_004_));
 sky130_fd_sc_hd__nor2_2 _068_ (.A(\data_edge_detector_inst.state[0] ),
    .B(rst),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_030_));
 sky130_fd_sc_hd__a22o_2 _069_ (.A1(data_in),
    .A2(_022_),
    .B1(_030_),
    ...
    .VPWR(VPWR),
    .X(_006_));
 sky130_fd_sc_hd__a22o_2 _070_ (.A1(\data_edge_detector_inst.input_buffer[0] ),
    .A2(_022_),
    .B1(_030_),
 ...
 sky130_fd_sc_hd__and2b_2 _071_ (.A_N(temp_reset),
    ...
    .VPWR(VPWR),
    .X(_031_));
 sky130_fd_sc_hd__o21ai_2 _072_ (.A1(_028_),
    .A2(_031_),
 ...
 sky130_fd_sc_hd__nand2_2 _075_ (.A(running),
    ...
    .VPWR(VPWR),
    .Y(_033_));
 sky130_fd_sc_hd__nor2_2 _076_ (.A(rst),
 ...
 sky130_fd_sc_hd__and3b_2 _081_ (.A_N(_037_),
    ...
    .VPWR(VPWR),
    .X(_011_));
 sky130_fd_sc_hd__o41a_2 _082_ (.A1(_023_),
    .A2(_024_),
    .A3(_025_),
    .A4(_033_),
    .B1(_034_),
 ...
 sky130_fd_sc_hd__a31o_2 _096_ (.A1(count_out[5]),
    ...
    .VPWR(VPWR),
    .X(_048_));
 sky130_fd_sc_hd__o211a_2 _097_ (.A1(_024_),
    .A2(_045_),
    .B1(_048_),
    .C1(_038_),
    .VGND(VGND),
